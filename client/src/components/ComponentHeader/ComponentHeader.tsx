"use client";
import Modal from "@/app/ui/modals/modals";
              ...
              <div className="p-1">
                <div className="mb-4.5 flex flex-col gap-6 xl:flex-row">
                  <div className="w-full xl:w-1/2">
                    ...
                    <input
                      type="text"
                      placeholder="Enter molecule string"
                ...
                <button className="flex w-full justify-center cursor-pointer text-white rounded-lg bg-primary p-3 font-medium text-gray hover:bg-opacity-90">
                  Add molecule
                </button>
              </div>
            </form>
